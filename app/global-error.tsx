...
export default function GlobalError({
  ...
  return (
    <html lang="ko">
      <body className="min-h-screen flex items-center justify-center bg-white antialiased">
        <div className="max-w-md mx-auto px-4 text-center">
          <div className="text-6xl mb-4">💥</div>
          <h2 className="text-xl font-bold text-gray-900 mb-2">심각한 오류가 발생했습니다</h2>
          <p className="text-sm text-gray-500 mb-6">
            페이지 전체에 문제가 발생했습니다. 잠시 후 다시 시도해주세요.
          </p>
