...
import { StatsData } from "@/lib/analytics/stats";
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              <div className="bg-white border border-zinc-200/80 p-6 rounded-2xl shadow-sm flex flex-col justify-between">
                ...
                <div className="space-y-4 max-h-[190px] overflow-y-auto pr-1">
                  ...
                  {/* 2. 상세 URL 링크 탭 활성화 시 */}
                  {referrerTab === "url" && (
                    !data.topReferrerUrls || data.topReferrerUrls.length === 0 ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              ...
              <div className="bg-white border border-zinc-200/80 p-6 rounded-2xl shadow-sm flex flex-col justify-between">
                <div>
                  ...
                  <p className="text-xs text-zinc-455 mb-5 font-medium">유저들이 가장 빈번하게 접속하여 조회한 페이지 경로입니다.</p>
                </div>
