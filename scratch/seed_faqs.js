...
async function main() {
  ...
  const faqItems = [
    ...
    {
      category: "하이카즈 특징",
      question: "왜 하이카즈 견적은 다른 곳보다 저렴한가요?",
      answer: "하이카즈는 영업 수수료 거품을 싹 뺀 정직한 견적만을 제안해 드리기 때문입니다. 불필요한 영업 마진을 제외하여 가장 합리적인 가격으로 차량을 이용하실 수 있습니다.",
    ...
    },
    {
      ...
      answer: "네, 가능합니다.\n\n일반적인 메이저 렌트카 회사에서는 불가하겠지만, 하이카즈의 '무심사 장기렌트' 상품을 통하면 가능합니다. 개인회생뿐만 아니라 신용불량, 연체, 파산 등 여러 사유로 메이저 업체 이용이 어려운 분들도 신용조회 없이 합리적인 조건으로 차량을 이용하실 수 있습니다.",
      sortOrder: 7,
      isPublished: true,
    },
    {
      ...
      answer: "네, 가능합니다.\n\n하이카즈는 신용 등급을 보지 않는 무심사 시스템을 운영하고 있어, 신용불량 고객님도 장기렌트 이용이 가능합니다. 일반 렌트사에서는 연체나 금융 기록 때문에 진행이 어렵지만, 하이카즈에서는 운전 가능한 조건만 충족된다면 대부분의 차종이 출고 가능합니다. (※ 단, 일부 고가 수입차나 고급 트림의 경우 소득 확인이 필요한 경우도 있습니다.)\n\n실제로도 신용불량, 개인회생, 신용회복 등으로 어려움을 겪는 상황에서 하이카즈를 통해 차량 출고에 성공하신 고객님들이 매우 많습니다.",
      sortOrder: 8,
      isPublished: true,
    },
    {
    ...
    },
    {
      ...
      answer: "네, 하이카즈에서 표기되는 모든 대여료는 부가세와 보험료가 모두 포함된 최종 금액입니다. 별도의 추가 비용 없이 안내된 금액 그대로 이용하실 수 있습니다.",
      sortOrder: 11,
      isPublished: true,
    },
    {
